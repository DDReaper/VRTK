...
using UnityEngine.XR;
    ...
    public class SDK_WindowsMRHeadset : SDK_BaseHeadset
    {
        /// <summary>
        ...
        {
            //(SJ) Revisit and identify component used for camera, suspect it's a prefab
        ...
        {
            //WindowsMR_Fade.Start(color, duration, fadeOverlay);
        }
        ...
        {
            //(SJ) Not sure MR has built in Fade? Will check
            return false;
        }
